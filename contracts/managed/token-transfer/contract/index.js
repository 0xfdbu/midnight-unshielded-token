...
class _Either_1 {
  alignment() {
    return _descriptor_7.alignment().concat(_descriptor_1.alignment().concat(_descriptor_5.alignment()));
  }
  fromValue(value_0) {
    return {
      is_left: _descriptor_7.fromValue(value_0),
  ...
  toValue(value_0) {
    return _descriptor_7.toValue(value_0.is_left).concat(_descriptor_1.toValue(value_0.left).concat(_descriptor_5.toValue(value_0.right)));
  }
}
...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      ...
      sendToUser: (...args_1) => {
        ...
        const partialProofData = {
          input: {
            value: _descriptor_4.toValue(amount_0).concat(_descriptor_5.toValue(userAddr_0)),
            alignment: _descriptor_4.alignment().concat(_descriptor_5.alignment())
          },
          output: undefined,
          publicTranscript: [],
  ...
  _mintStablecoin_0(context, partialProofData, amount_0, recipient_0) {
    ...
    const tmp_0 = ((t1) => {
                    if (t1 > 65535n) {
                      throw new __compactRuntime.CompactError('Contract.compact line 15 char 27: cast from Field or Uint value to smaller Uint value failed: ' + t1 + ' is greater than 65535');
                    }
                    return t1;
                  })(amount_0);
    __compactRuntime.queryLedgerState(context,
  ...
  _burnStablecoin_0(context, partialProofData, amount_0) {
    ...
    const tmp_0 = ((t1) => {
                    if (t1 > 65535n) {
                      throw new __compactRuntime.CompactError('Contract.compact line 23 char 27: cast from Field or Uint value to smaller Uint value failed: ' + t1 + ' is greater than 65535');
                    }
                    return t1;
                  })(amount_0);
    __compactRuntime.queryLedgerState(context,
